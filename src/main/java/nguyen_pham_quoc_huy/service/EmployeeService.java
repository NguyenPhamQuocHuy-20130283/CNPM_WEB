package nguyen_pham_quoc_huy.service;

import nguyen_pham_quoc_huy.dao.EmployeeDAO;
import nguyen_pham_quoc_huy.dao.RoleDAO;
import nguyen_pham_quoc_huy.model.Address;
import nguyen_pham_quoc_huy.model.Employee;
import nguyen_pham_quoc_huy.model.HashGenerator;
import nguyen_pham_quoc_huy.model.Role;
...
import static nguyen_pham_quoc_huy.constant.Constants.*;
import static nguyen_pham_quoc_huy.util.FileUploadUtils.*;
...
public class EmployeeService {
     ...
     * @throws IOException      If an input or output error is detected when the servlet handles the POST request
     */
    public void updateEmployee() throws ServletException, IOException, HashGenerationException {
        Integer id = Integer.valueOf(request.getParameter("id"));
     ...
     * @throws IOException      If an input or output error is detected when the servlet handles the POST request
     */
    public void checkLogin() throws ServletException, IOException, HashGenerationException {
        String email = request.getParameter("email");
